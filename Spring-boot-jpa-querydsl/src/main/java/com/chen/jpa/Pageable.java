...
public class Pageable implements Serializable {
	...
	/** 文本筛选运算符 */
	public static FilterOperatorEnum[] textFilterOperators = { FilterOperatorEnum.eq, FilterOperatorEnum.like };
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getPageNumber(), pageable.getPageNumber())
				.append(getPageSize(), pageable.getPageSize()).append(getSearchProperty(), pageable.getSearchProperty())
